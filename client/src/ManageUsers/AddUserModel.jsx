...
function AddUserModel(props) {
  ...
  useEffect(() => {
    if (props.editFormData !== undefined && props.editFormData !== null) {
      setData({
        _id: props.editFormData._id,
        firstName: props.editFormData.firstName,
        lastName: props.editFormData.lastName,
        email: props.editFormData.email,
        DOB:
          props.editFormData.DOB && props.editFormData.DOB.length > 10
            ? HelperUtils.formateDate(props.editFormData.DOB)
            : props.editFormData.DOB,
        phoneNumber: props.editFormData.phoneNumber,
        gender: props.editFormData.gender,
        roles: getRolesInArrayFormat(props.editFormData.roles),
      });
      clearErrors();
    } else {
      setData({
  ...
  return (
    <div className="AddUser-Model">
      <Dialog
        className="MuiDialog-paper-AddUserModel"
        open={props.open}
        onClose={props.onClose}
      >
        <MuiDialogTitle>
          <img
            src={constructImage(props.editFormData)}
            alt=""
        ...
        <DialogContent>
          ...
          <TextField
            ...
            name="email"
            disabled={
              props.editFormData && props.editFormData._id !== "" ? true : false
            }
            onChange={handleChange}
          ...
          <div className="secondRow">
            ...
            <Autocomplete
              ...
              onChange={(event, value) => {
                ...
                let rls = value.filter(
                  (v, i, a) =>
                    a.findIndex((t) => t.role_name === v.role_name) === i
                );
        ...
        <DialogActions>
          <Button
            ...
            color="primary"
          >
            {props.editFormData !== undefined && props.editFormData !== null
              ? "Update"
              : "AddUser"}
          </Button>
