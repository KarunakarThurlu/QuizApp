...
function SubmitQuestion(props) {
  ...
  const { getAllQuestions, questions, deleteQuestion, updateQuestion } =
  ...
  const columns = [
    ...
    },
    {
      ...
      filterComponent: () => (
        <Autocomplete
          ...
          onChange={(event) => {
            ...
            const creatorId = userLabelOptions.filter(
              (e) => e.email === creatorName
            );
            const filteredObject = {
              ...filtersData,
              creator: creatorName !== "" ? creatorId[0]._id : "",
            };
      ...
      render: (params) => (
        <ToolTipUtil
          key={params.creator_name}
          toolTipData={params.creator_name}
          length={20}
        />
      ),
    },
  ...
  return (
    <div className="questions-container">
      ...
      {updateQuestioninList && (
        <ChangeQuestionStatusModel
          updateQuestion={updateQuestioninList}
          open={statusModelOpen}
          CQData={currentQuestion}
      ...
      <WarningPopupModel
        ...
        message={CommonConstants.Delete_Question_Warning}
        onClickYes={handleDeleteQuestion}
